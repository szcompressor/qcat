...
int main(int argc, char * argv[])
{
    ...
    if(argc < 3)
    {
		printf("Test case: convertBytesToTxtFloat [srcFilePath] newsize [tgtFilePath]\n");
		printf("Example: convertBytesToTxtFloat testfloat_8_8_128.dat 200 testfloat_8_8_128.xls\n");
		printf("Example: convertBytesToTxtFloat testfloat_8_8_128.dat -1 testfloat_8_8_128.xls\n");
		exit(0);
    }
