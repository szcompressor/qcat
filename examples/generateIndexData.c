...
int main(int argc, char * argv[])
{
    ...
    if(argc < 3)
    {
		printf("Test case: generateRandomData [tgtFilePath] outSize\n");
		printf("Example: generateRandomData test.dat 200\n");
		exit(0);
    }
    ...
    writeFloatData_inBytes(data, newSize, outputFilePath, &status);
    free(data);
